                ...
                <div class="killore-new-block-link border mb-3 mt-3">
                    ...
                    <div class="killore--block-link-content">
                        <ul>
                            ...
                            <li><a href="javascript:void(0);"><i class="fa {{ $category->icon }}"></i>{{$category->category_name}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="text-left">
                            <div class="text-left">
                                ...
                                <div class="elis_rty">
                                    ...
                                    @if ($product->discount != null)
                                    BDT:
                                    <span class="ft-medium text-muted line-through fs-md mr-2 "> {{number_format($product->price)}}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="smart-brand text-center">
                    @foreach ($products as $product)
                    <div class="single-brnads">
                        <h3 style="border-right: 1px solid #000">{{ $product->brand }}</h3>
                    </div>
                    @endforeach
                </div>
            </div>
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center circle border"><a href="javascript:void(0);" class="d-block">
                        <i style="font-size: 30px; width: 70px; height: 70px; line-height: 70px;" class="fa {{$category->icon}}"></i>
                    </a></div></div>
