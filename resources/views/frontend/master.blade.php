					...
					<div class="row">
						...
						<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="currency-selector dropdown js-dropdown float-right mr-3">
                                ...
                                <div class="dropdown">
                                <a class="dropdown-toggle text-muted medium" href="#" role="button" data-toggle="dropdown" aria-expanded="false"><i class="lni lni-user mr-1"></i>
                                    {{Auth::guard('customerlogin')->user()->name}}
                                </a>

                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item text-muted medium" href="#">My Account</a></li>
                                    <li><a class="dropdown-item text-muted medium" href="{{route('customer.logout')}}">Logout</a></li>
                                </ul>
                                </div>
                            </div>
                            @else
							...
							<div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									...
									<div class="cart_single_caption pl-2">
										...
										<h4 class="fs-md ft-medium mb-0 lh-1">TK: {{number_format($cart->rel_to_product->after_discount)}}</h4>
									</div>
								</div>
